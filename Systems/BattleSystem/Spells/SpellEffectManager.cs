    ...
    private void SetSpellEffects()
    {
        SpellEffects = new Dictionary<SpellMode, List<SpellEffect>> {
            ...
            {SpellMode.LunarBlast, new List<SpellEffect>(){ // duration effects first
                ...
                ToolTip = "Launch a bolt imbued with moonlight at the target area! Damages foes and heals allies! Range 6, Cost 18, Area 9."
                },
                new SpellEffect(){
                    Name = "Lunar Blast",
                    RangeSquares = 6,
            ...
            {SpellMode.PerilOfOsiris, new List<SpellEffect>(){ 
                ...
                ToolTip = "Throw an enchanted poison dart at the opponent, dealing damage over 3 rounds! Range 5, Cost 12."
            }, 
                new SpellEffect(){
                Name = "Peril of Osiris",
                RangeSquares = 4,
